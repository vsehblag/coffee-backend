...
```
cd existing_repo
git remote add origin https://gitlab.com/dealfinder/backend/dealfinder-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dealfinder/backend/dealfinder-backend/-/settings/integrations)
